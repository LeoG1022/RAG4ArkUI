...
| 3 | 0.0159 | 0.6978 | — | dynamic-introduction.md L4-12 | 动态化介绍 > 简介 |
...
| 2 | 0.0161 | 0.6925 | — | ffi-napi-introduction.md L6-10 | FFI能力(N-API) > ArkUI-X中N-API的使用场景 |
| 3 | 0.0159 | 0.6917 | — | start-with-ability-on-ios.md L14-26 | 通过Stage模型开发iOS端应用指南 > ArkUI-X和iOS平台集成所用关键类 > StageViewController > 公共属性 |
...
| # | rrf | vector | bm25 | source | heading |
|---|---|---|---|---|---|
| 1 | 0.0164 | 0.6470 | — | start-with-ability-on-ios.md L337-337 | xxx.ets > 2. WantParams工具类 |
| 2 | 0.0161 | 0.6470 | — | start-with-ability-on-android.md L188-188 | xxx.ets > 2. WantParams工具类 |
| 3 | 0.0159 | 0.6297 | — | start-with-ability-on-ios.md L300-307 | 通过Stage模型开发iOS端应用指南 > 通过iOS原生拉起Ability并传递参数 > 1. 使用手动方式 > 支持的参数类型列表 |
...
| # | rrf | vector | bm25 | source | heading |
|---|---|---|---|---|---|
| 1 | 0.0164 | 0.6181 | — | start-with-ability-on-ios.md L337-337 | xxx.ets > 2. WantParams工具类 |
| 2 | 0.0161 | 0.6181 | — | start-with-ability-on-android.md L188-188 | xxx.ets > 2. WantParams工具类 |
| 3 | 0.0159 | 0.6161 | — | ios-slip-left-back.md L4-6 | IOS跨平台页面实现手势返回指南 > 简介 |
